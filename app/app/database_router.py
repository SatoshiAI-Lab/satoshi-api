...
class DatabaseAppsRouter(object):
    ...
    def allow_relation(self, obj1, obj2, **hints) -> None | bool:
        """Allow any relation between apps that use the same database."""
        db_obj1: str | None = DATABASE_MAPPING.get(obj1._meta.app_label)
        db_obj2: str | None = DATABASE_MAPPING.get(obj2._meta.app_label)
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints) -> None | bool:
