...
class ResponseUtil():
    ...
    def success(data: dict | None=None, msg: str='OK') -> Response:
        return resp(status=status_code.HTTP_200_OK, message=msg, data=data)
    
    @staticmethod
    def miss_field(data: dict | None=None, msg: str='This field is required.') -> Response:
        return resp(status=status_code.HTTP_400_BAD_REQUEST, message=msg, data=data)
    ...
    def request_timeout(data: dict | None=None, msg: str='Request timeout.') -> Response:
        return resp(status=status_code.HTTP_408_REQUEST_TIMEOUT, message=msg, data=data)
    
    @staticmethod
    def web3_error(data: dict | None=None, msg: str='Web3 request error.') -> Response:
        return resp(status=status_code.HTTP_421_MISDIRECTED_REQUEST, message=msg, data=data)

    @staticmethod
    def too_high_frequency(data: dict | None=None, msg: str='Too high frequency.') -> Response:
        return resp(status=status_code.HTTP_429_TOO_MANY_REQUESTS, message=msg, data=data)
